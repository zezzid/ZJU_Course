...
static void InitColors(void)
{
    ...
    DefineColor("Light Gray", .557, .557, .62);
    DefineColor("White", 1, 1, 1);
    DefineColor("Brown", .498, .35, .23);//
    DefineColor("Red", .64, .2, .164);//
    DefineColor("Orange", .81, .43, .1);//
    DefineColor("Yellow", .89, .788, .078);//
    DefineColor("Green", 0, 1, 0);
    DefineColor("Blue", .3, .42, .68);//
    DefineColor("Violet", .93, .5, .93);
    DefineColor("Magenta", .77, .43, .56);//
    DefineColor("Cyan", .243, .564, .505);//
}
