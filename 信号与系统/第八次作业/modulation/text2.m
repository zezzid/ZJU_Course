...
audiowrite('voice3AfterLowpassFilter.wav', x3_low, fs);
audiowrite('voice4AfterLowpassFilter.wav', x4_low, fs);%把低通滤波结果保存
...
fc2 = 18000;
fc3 = 27000;
fc4 = 36000;%以上两句分别定义了wc1,wc2,wc3,wc4.
for i =1:length(x5)
...
audiowrite('voice1and2and3and4AfterModulation.wav', x5, fs);
...
audiowrite('voice3AfterDemodulation.wav', x3_afterModulation, fs);
audiowrite('voice4AfterDemodulation.wav', x4_afterModulation, fs);